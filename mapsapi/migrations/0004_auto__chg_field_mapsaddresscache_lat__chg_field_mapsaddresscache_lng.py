...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MapsAddressCache.lat'
        db.alter_column(u'mapsapi_mapsaddresscache', 'lat', self.gf('django.db.models.fields.CharField')(max_length=90))

        # Changing field 'MapsAddressCache.lng'
        db.alter_column(u'mapsapi_mapsaddresscache', 'lng', self.gf('django.db.models.fields.CharField')(max_length=90))
