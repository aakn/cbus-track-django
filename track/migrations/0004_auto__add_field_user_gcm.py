...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.gcm'
        db.add_column(u'track_user', 'gcm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.gcm'
        db.delete_column(u'track_user', 'gcm')
    ...
    models = {
        ...
        u'track.user': {
            ...
            'gcm': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
