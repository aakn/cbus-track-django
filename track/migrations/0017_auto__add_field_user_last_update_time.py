...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.last_update_time'
        db.add_column(u'track_user', 'last_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default='2012-01-01 01:00', auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.last_update_time'
        db.delete_column(u'track_user', 'last_update_time')
    ...
    models = {
        ...
        u'track.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update_time': ('django.db.models.fields.DateTimeField', [], {'default': "'2012-01-01 01:00'", 'auto_now': 'True', 'blank': 'True'}),
