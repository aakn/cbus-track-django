...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.gcm'
        db.alter_column(u'track_user', 'gcm', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.gcm'
        db.alter_column(u'track_user', 'gcm', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
