...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyRequestCounter'
        db.create_table(u'track_dailyrequestcounter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'track', ['DailyRequestCounter'])


    def backwards(self, orm):
        # Deleting model 'DailyRequestCounter'
        db.delete_table(u'track_dailyrequestcounter')
    ...
    models = {
        ...
        u'track.dailyrequestcounter': {
            'Meta': {'object_name': 'DailyRequestCounter'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'track.routedetail': {
