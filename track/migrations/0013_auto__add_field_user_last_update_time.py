...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'track_user', 'last_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default='', auto_now=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'track.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update_time': ('django.db.models.fields.DateTimeField', [], {'default': "''", 'auto_now': 'True', 'blank': 'True'}),
