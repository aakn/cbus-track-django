...
DATABASES = {
    'default': {
        ...
        'NAME': 'cbus',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'insignia',                  # Not used with sqlite3.
...
ALLOWED_HOSTS = ['localhost:8000', 'localhost', '.insigniadevs.com', '.pesseacm.org']
...
SECRET_KEY = 'f0$te*#)_*^5$684)#@bq9n)u@40vb4x#^r+-1$=jpf$^scks9'
...
ROOT_URLCONF = 'cbustrack.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cbustrack.wsgi.application'
